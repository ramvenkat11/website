...
line, now "Code editor · validation with full trace · versioned", each linked:
development/code-editor.html, development/validation-and-publishing.html, and its #publishing
