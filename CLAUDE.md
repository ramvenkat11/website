...
describe, wait for indexing); the docs step's h2 is "Ask the docs" (was "Ask a question", Ram); step 6 is just "Search": "Type a question in the search box: the agent matches,
runs and answers."
